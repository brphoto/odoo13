...
class AccountTax(models.Model):
    ...
    # Campos para facturacion electronica y ATS
    impuesto = fields.Char('Código del impuesto en el formulario', )

    # Codigo del impuesto, TABLAS 16, 19 y 22
    codigo = fields.Char('Código del impuesto en documentos electrónicos', )

    # codigoRetencion en retenciones y codigoPorcentaje en facturas.
    # En las retenciones de IR (RetRenta) se usa el campo impuesto.
    # TABLAS 17, 18, 20, 23
