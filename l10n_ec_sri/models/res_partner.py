...
class ResPartner(models.Model):
    ...
    vat = fields.Char('Identificacion fiscal', size=13, required=True, help='R.U.C / C.I. / Pasaporte')
    ...
    def on_change_vat(self):
        if self.vat:
            self.property_account_position_id =self._get_fiscal_position(self.vat)
