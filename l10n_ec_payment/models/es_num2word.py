...
class to_word(models.Model):
    _name = 'spanish.to_word'
...
def to_word(number):
    ...
    return converted + 'CON ' + str(int(x)).zfill(2) + '/100'
...
def extraeDecimales(nNumero, max_digits=2):
        ...
        strDecimales = strDecimales[00:max_digits]
